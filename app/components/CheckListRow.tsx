    ...
    <div className="flex items-center justify-between gap-3 bg-white border border-gray-200 rounded-lg px-3 py-2">
      ...
      <div className="flex items-center gap-3 flex-1">
        ...
        <button
          ...
          className={`p-1.5 rounded-full text-white transition active:scale-95 ${
            item.done
      ...
      <div className="flex items-center gap-2">
        {!editing && (
          <button
            ...
            className="p-1.5 rounded-md bg-gray-200 hover:bg-gray-300 text-gray-700 active:scale-95 transition"
          >
            <FiEdit2 size={14} />
          </button>
        )}
